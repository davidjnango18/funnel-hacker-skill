...
4. Set up affiliate/referral incentives (for channel partner launches, use [Introw](references/tools/integrations/introw.md) to manage deal registration and commissions)
