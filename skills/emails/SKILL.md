...
For implementation, see the [tools registry](references/tools/README.md). Key email tools:
...
| **Nitrosend** | AI-native email (sequences via prompts) | ✓ | [nitrosend.md](references/tools/integrations/nitrosend.md) |
