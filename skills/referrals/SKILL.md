...
For implementation, see the [tools registry](references/tools/README.md). Key tools for referral programs:
...
| **Introw** | Channel partner programs with tiers, deal registration, QBRs | [introw.md](references/tools/integrations/introw.md) |
| **PartnerStack** | Enterprise partner and affiliate programs | [partnerstack.md](references/tools/integrations/partnerstack.md) |
