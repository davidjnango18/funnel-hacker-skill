...
For implementation, see the [tools registry](references/tools/README.md). Key prospecting tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Apollo** | B2B / SaaS firmographic + contact discovery | - | [apollo.md](references/tools/integrations/apollo.md) |
| **Clay** | Multi-source enrichment + waterfall | ✓ | [clay.md](references/tools/integrations/clay.md) |
| **Clearbit** | Email-to-company enrichment | - | [clearbit.md](references/tools/integrations/clearbit.md) |
| **ZoomInfo** | Enterprise B2B contact + intent | ✓ | [zoominfo.md](references/tools/integrations/zoominfo.md) |
| **Hunter** | Email pattern + verification | - | [hunter.md](references/tools/integrations/hunter.md) |
| **Snov** | Email finder + verifier | - | [snov.md](references/tools/integrations/snov.md) |
| **Truelist** | Email deliverability validation | - | [truelist.md](references/tools/integrations/truelist.md) |
| **Outreach** | Sales engagement (post-list) | ✓ | [outreach.md](references/tools/integrations/outreach.md) |
| **RB2B** | Visitor identification (warm intent) | - | [rb2b.md](references/tools/integrations/rb2b.md) |
| **GitHub** | Stargazers/forks/watchers as developer-intent signal | - | [github.md](references/tools/integrations/github.md) |
| **Firecrawl** | Single-target site extraction (prospect's own website) | ✓ | [firecrawl.md](references/tools/integrations/firecrawl.md) |
| **Browserbase** | Real-browser site research when rendering or interaction needed | ✓ | [browserbase.md](references/tools/integrations/browserbase.md) |
