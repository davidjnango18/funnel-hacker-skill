...
node references/tools/clis/github-prospects.js stargazers vercel/next.js \
...
```bash
node references/tools/clis/github-prospects.js forks yourorg/yourrepo \
...
```bash
node references/tools/clis/github-prospects.js watchers tldraw/tldraw \
...
```bash
# Stargazers
node references/tools/clis/github-prospects.js stargazers <owner/repo> \
  [--limit N] [--enrich] [--with-email] [--with-company] \
  [--with-blog] [--type User|Organization] [--format csv|json]

# Forks
node references/tools/clis/github-prospects.js forks <owner/repo> [...same flags]

# Watchers (subscribers in API terms)
node references/tools/clis/github-prospects.js watchers <owner/repo> [...same flags]

# Single user lookup
node references/tools/clis/github-prospects.js user <username>

# Check rate limit
node references/tools/clis/github-prospects.js rate-limit
```
