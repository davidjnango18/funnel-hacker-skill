...
2. Pull stargazers (or forks for stronger intent) via `node references/tools/clis/github-prospects.js stargazers <owner/repo> --enrich --with-company --format csv`
