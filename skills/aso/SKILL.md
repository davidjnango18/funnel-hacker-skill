...
Use the available web or browser capability to retrieve the listing page. Extract every available field:
...
If the available web or browser capability returns incomplete data (stores render client-side), note gaps and
work with what's available. Ask the user to paste missing fields if critical.

### Visual asset assessment

If the current web capability cannot extract screenshot images or caption text. **Take a screenshot
