...
**Check for product marketing context first:** if `.agents/product-marketing.md` exists, read it before asking questions. Use that context and only ask for what's missing.
