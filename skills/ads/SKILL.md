...
For implementation, see the [tools registry](references/tools/README.md). Key advertising platforms:
...
For tracking setup, see [references/conversion-tracking.md](references/conversion-tracking.md), [ga4.md](references/tools/integrations/ga4.md), [segment.md](references/tools/integrations/segment.md)

---

## Related Skills

- **funnel-ad-creative**: For generating and iterating ad headlines, descriptions, and creative at scale
