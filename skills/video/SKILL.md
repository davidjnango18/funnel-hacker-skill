...
| Tool | Type | MCP | Guide |
|------|------|:---:|-------|
| **HeyGen** | AI avatars | Yes | [heygen.md](references/tools/integrations/heygen.md) |
| **Hyperframes** | Programmatic video | - | [hyperframes.md](references/tools/integrations/hyperframes.md) |
...
- **funnel-ad-creative**: For paid video ad creative and iteration
