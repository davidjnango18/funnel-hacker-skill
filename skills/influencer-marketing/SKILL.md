...
**Check for product marketing context first.** If `.agents/product-marketing.md` exists, read it before asking questions — the ICP, positioning, and offer anchor every partner-fit decision. Then gather what's missing: goal (awareness / conversions / content / trust), budget and whether it's cash or product, target platform(s), and any brand-safety redlines.
...
For implementation, see the [tools registry](references/tools/README.md).

| Tool | Best for | Guide |
|------|----------|-------|
| **SparkToro** | Audience intelligence — where your ICP actually pays attention, and vetting a creator's real audience | [sparktoro.md](references/tools/integrations/sparktoro.md) |
